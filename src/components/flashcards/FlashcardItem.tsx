  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Front side */}
        <div
          className={`absolute inset-0 w-full h-full flex flex-col justify-center items-center p-6 bg-gradient-to-b from-secondary/15 to-transparent bg-background rounded-lg border border-gray-700 transition-all duration-300 ${
            isFlipped
              ? "opacity-0 -z-10 transform rotate-y-180"
              : "opacity-100 z-10"
          }`}
        >
        ...
        {/* Back side */}
        <div
          className={`absolute inset-0 w-full h-full flex flex-col justify-center items-center p-6 bg-gradient-to-b from-accent/15 to-transparent bg-background rounded-lg border border-gray-700 transition-all duration-300 ${
            isFlipped
              ? "opacity-100 z-10"
              : "opacity-0 -z-10 transform rotate-y-180"
          }`}
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center gap-3 p-3 z-20">
        {" "}
        <button
          onClick={(e) => {
            e.stopPropagation();
